...
@property (strong, nonatomic) NSString *svgString;		// svg format suitable for web use
@property (strong, nonatomic) NSString *xmlString;		// ISO/IEC 19794-7 xml formatted output
